...
// struct ag::Arcball
template <>
struct RecordReflect<ag::Arcball> {
	// attribute instances
...
const Record RecordReflect<ag::Arcball>::metaobj { "ag::Arcball", 
	  gsl::span<Field>{} ,
...
template <>
const Type* typeOf<ag::Arcball>() {
return &RecordReflect<ag::Arcball>::metaobj;
}

///////////////////////////
// struct ag::CameraControl
template <>
struct RecordReflect<ag::CameraControl> {
	// attribute instances
...
const Record RecordReflect<ag::CameraControl>::metaobj { "ag::CameraControl", 
	  gsl::span<Field>{} ,
	  gsl::span<std::type_index>{} ,
	{},	// attribute table
	&RecordReflect<ag::CameraControl>::serialize,	// serialize
	nullptr // deserialize
	};

template <>
const Type* typeOf<ag::CameraControl>() {
return &RecordReflect<ag::CameraControl>::metaobj;
}

///////////////////////////
// struct ag::CVarBase
template <>
struct RecordReflect<ag::CVarBase> {
	// attribute instances
...
const std::array<Field, 1> RecordReflect<ag::CVarBase>::field_data  { {
	Field { "id", "ag::CVarBase::id", std::type_index{typeid(std::basic_string<char, std::char_traits<char>, std::allocator<char> >)}, offsetof(ag::CVarBase, id), &RecordReflect<ag::CVarBase>::field_thunk_id, 
	  {}  }, 
}};



const Record RecordReflect<ag::CVarBase>::metaobj { "ag::CVarBase", 
...
template <>
struct RecordReflect<ag::Profiler::Scope> {
	// attribute instances
	...
	static void* field_thunk_gpuTimestampStartQuery(void* ptr) {
		return &reinterpret_cast<ag::Profiler::Scope*>(ptr)->gpuTimestampStartQuery;
	}
...
const std::array<Field, 13> RecordReflect<ag::Profiler::Scope>::field_data  { {
	Field { "gpuProfile", "ag::Profiler::Scope::gpuProfile", std::type_index{typeid(bool)}, offsetof(ag::Profiler::Scope, gpuProfile), &RecordReflect<ag::Profiler::Scope>::field_thunk_gpuProfile, 
	  {}  }, 
	Field { "gpuClientTimestampRef", "ag::Profiler::Scope::gpuClientTimestampRef", std::type_index{typeid(long long)}, offsetof(ag::Profiler::Scope, gpuClientTimestampRef), &RecordReflect<ag::Profiler::Scope>::field_thunk_gpuClientTimestampRef, 
	  {}  }, 
	Field { "gpuTimestampStartQuery", "ag::Profiler::Scope::gpuTimestampStartQuery", std::type_index{typeid(ag::gl::TimestampQuery)}, offsetof(ag::Profiler::Scope, gpuTimestampStartQuery), &RecordReflect<ag::Profiler::Scope>::field_thunk_gpuTimestampStartQuery, 
	  {}  }, 
	Field { "gpuTimestampEndQuery", "ag::Profiler::Scope::gpuTimestampEndQuery", std::type_index{typeid(ag::gl::TimestampQuery)}, offsetof(ag::Profiler::Scope, gpuTimestampEndQuery), &RecordReflect<ag::Profiler::Scope>::field_thunk_gpuTimestampEndQuery, 
	  {}  }, 
	Field { "name", "ag::Profiler::Scope::name", std::type_index{typeid(std::basic_string<char, std::char_traits<char>, std::allocator<char> >)}, offsetof(ag::Profiler::Scope, name), &RecordReflect<ag::Profiler::Scope>::field_thunk_name, 
	  {}  }, 
	Field { "start", "ag::Profiler::Scope::start", std::type_index{typeid(std::chrono::time_point<std::chrono::steady_clock, std::chrono::duration<long long, std::ratio<1, 1000000000> > >)}, offsetof(ag::Profiler::Scope, start), &RecordReflect<ag::Profiler::Scope>::field_thunk_start, 
	  {}  }, 
	Field { "end", "ag::Profiler::Scope::end", std::type_index{typeid(std::chrono::time_point<std::chrono::steady_clock, std::chrono::duration<long long, std::ratio<1, 1000000000> > >)}, offsetof(ag::Profiler::Scope, end), &RecordReflect<ag::Profiler::Scope>::field_thunk_end, 
	  {}  }, 
	Field { "gpuStart", "ag::Profiler::Scope::gpuStart", std::type_index{typeid(std::chrono::duration<long long, std::ratio<1, 1000000000> >)}, offsetof(ag::Profiler::Scope, gpuStart), &RecordReflect<ag::Profiler::Scope>::field_thunk_gpuStart, 
	  {}  }, 
	Field { "gpuEnd", "ag::Profiler::Scope::gpuEnd", std::type_index{typeid(std::chrono::duration<long long, std::ratio<1, 1000000000> >)}, offsetof(ag::Profiler::Scope, gpuEnd), &RecordReflect<ag::Profiler::Scope>::field_thunk_gpuEnd, 
	  {}  }, 
	Field { "id", "ag::Profiler::Scope::id", std::type_index{typeid(int)}, offsetof(ag::Profiler::Scope, id), &RecordReflect<ag::Profiler::Scope>::field_thunk_id, 
	  {}  }, 
	Field { "parent", "ag::Profiler::Scope::parent", std::type_index{typeid(int)}, offsetof(ag::Profiler::Scope, parent), &RecordReflect<ag::Profiler::Scope>::field_thunk_parent, 
	  {}  }, 
	Field { "next", "ag::Profiler::Scope::next", std::type_index{typeid(int)}, offsetof(ag::Profiler::Scope, next), &RecordReflect<ag::Profiler::Scope>::field_thunk_next, 
	  {}  }, 
	Field { "firstChild", "ag::Profiler::Scope::firstChild", std::type_index{typeid(int)}, offsetof(ag::Profiler::Scope, firstChild), &RecordReflect<ag::Profiler::Scope>::field_thunk_firstChild, 
	  {}  }, 
}};



const Record RecordReflect<ag::Profiler::Scope>::metaobj { "ag::Profiler::Scope", 
...
template <>
const Type* typeOf<ag::Profiler::Scope>() {
...
template <>
struct RecordReflect<ag::Profiler::ProfileData> {
	// attribute instances
...
const std::array<Field, 4> RecordReflect<ag::Profiler::ProfileData>::field_data  { {
	Field { "frameId", "ag::Profiler::ProfileData::frameId", std::type_index{typeid(unsigned long long)}, offsetof(ag::Profiler::ProfileData, frameId), &RecordReflect<ag::Profiler::ProfileData>::field_thunk_frameId, 
	  {}  }, 
	Field { "frameStartTime", "ag::Profiler::ProfileData::frameStartTime", std::type_index{typeid(std::chrono::time_point<std::chrono::steady_clock, std::chrono::duration<long long, std::ratio<1, 1000000000> > >)}, offsetof(ag::Profiler::ProfileData, frameStartTime), &RecordReflect<ag::Profiler::ProfileData>::field_thunk_frameStartTime, 
	  {}  }, 
	Field { "frameEndTime", "ag::Profiler::ProfileData::frameEndTime", std::type_index{typeid(std::chrono::time_point<std::chrono::steady_clock, std::chrono::duration<long long, std::ratio<1, 1000000000> > >)}, offsetof(ag::Profiler::ProfileData, frameEndTime), &RecordReflect<ag::Profiler::ProfileData>::field_thunk_frameEndTime, 
	  {}  }, 
	Field { "scopes", "ag::Profiler::ProfileData::scopes", std::type_index{typeid(std::vector<ag::Profiler::Scope, std::allocator<ag::Profiler::Scope> >)}, offsetof(ag::Profiler::ProfileData, scopes), &RecordReflect<ag::Profiler::ProfileData>::field_thunk_scopes, 
	  {}  }, 
}};



const Record RecordReflect<ag::Profiler::ProfileData>::metaobj { "ag::Profiler::ProfileData", 
...
template <>
const Type* typeOf<ag::Profiler::ProfileData>() {
...
template <>
struct RecordReflect<ag::EntityManager> {
	// attribute instances
...
const Record RecordReflect<ag::EntityManager>::metaobj { "ag::EntityManager", 
	  gsl::span<Field>{} ,
	  gsl::span<std::type_index>{} ,
	{},	// attribute table
...
template <>
const Type* typeOf<ag::EntityManager>() {
...
template <>
struct RecordReflect<ag::ComponentManagerBase> {
	// attribute instances
...
const Record RecordReflect<ag::ComponentManagerBase>::metaobj { "ag::ComponentManagerBase", 
	  gsl::span<Field>{} ,
	  gsl::span<std::type_index>{} ,
	{},	// attribute table
...
template <>
const Type* typeOf<ag::ComponentManagerBase>() {
...
const Record RecordReflect<ag::Scene>::metaobj { "ag::Scene", 
	  gsl::span<Field>{} ,
	  gsl::span<std::type_index>{} ,
	{},	// attribute table
...
template <>
struct RecordReflect<ag::RenderableComponents> {
	// attribute instances
...
const std::array<std::type_index, 1> RecordReflect<ag::RenderableComponents>::bases_data { {
	std::type_index { typeid(ag::ComponentManager<ag::StdMaterial>) } ,
} };


const Record RecordReflect<ag::RenderableComponents>::metaobj { "ag::RenderableComponents", 
	  gsl::span<Field>{} ,
...
template <>
const Type* typeOf<ag::RenderableComponents>() {
...
template <>
struct RecordReflect<ag::SceneObject> {
	// attribute instances
...
const std::array<Field, 10> RecordReflect<ag::SceneObject>::field_data  { {
	Field { "entityID", "ag::SceneObject::entityID", std::type_index{typeid(unsigned long long)}, offsetof(ag::SceneObject, entityID), &RecordReflect<ag::SceneObject>::field_thunk_entityID, 
	  {}  }, 
	Field { "name", "ag::SceneObject::name", std::type_index{typeid(std::basic_string<char, std::char_traits<char>, std::allocator<char> >)}, offsetof(ag::SceneObject, name), &RecordReflect<ag::SceneObject>::field_thunk_name, 
	  {}  }, 
	Field { "parent", "ag::SceneObject::parent", std::type_index{typeid(ag::SceneObject *)}, offsetof(ag::SceneObject, parent), &RecordReflect<ag::SceneObject>::field_thunk_parent, 
	  {}  }, 
	Field { "mesh", "ag::SceneObject::mesh", std::type_index{typeid(ag::Mesh<ag::Vertex3D> *)}, offsetof(ag::SceneObject, mesh), &RecordReflect<ag::SceneObject>::field_thunk_mesh, 
	  {}  }, 
	Field { "localTransform", "ag::SceneObject::localTransform", std::type_index{typeid(ag::Transform)}, offsetof(ag::SceneObject, localTransform), &RecordReflect<ag::SceneObject>::field_thunk_localTransform, 
	  {}  }, 
	Field { "worldTransform", "ag::SceneObject::worldTransform", std::type_index{typeid(glm::tmat4x4<float, glm::precision::packed_highp>)}, offsetof(ag::SceneObject, worldTransform), &RecordReflect<ag::SceneObject>::field_thunk_worldTransform, 
	  {}  }, 
	Field { "children", "ag::SceneObject::children", std::type_index{typeid(std::vector<ag::SceneObject *, std::allocator<ag::SceneObject *> >)}, offsetof(ag::SceneObject, children), &RecordReflect<ag::SceneObject>::field_thunk_children, 
	  {}  }, 
	Field { "worldBounds", "ag::SceneObject::worldBounds", std::type_index{typeid(ag::AABB)}, offsetof(ag::SceneObject, worldBounds), &RecordReflect<ag::SceneObject>::field_thunk_worldBounds, 
	  {}  }, 
	Field { "localBounds", "ag::SceneObject::localBounds", std::type_index{typeid(ag::AABB)}, offsetof(ag::SceneObject, localBounds), &RecordReflect<ag::SceneObject>::field_thunk_localBounds, 
	  {}  }, 
	Field { "hasWorldBounds", "ag::SceneObject::hasWorldBounds", std::type_index{typeid(bool)}, offsetof(ag::SceneObject, hasWorldBounds), &RecordReflect<ag::SceneObject>::field_thunk_hasWorldBounds, 
	  {}  }, 
}};



const Record RecordReflect<ag::SceneObject>::metaobj { "ag::SceneObject", 
...
template <>
const Type* typeOf<ag::SceneObject>() {
...
template <>
struct RecordReflect<ag::SceneObjectComponents> {
	// attribute instances
...
const std::array<std::type_index, 1> RecordReflect<ag::SceneObjectComponents>::bases_data { {
	std::type_index { typeid(ag::ComponentManager<ag::SceneObject>) } ,
} };


const Record RecordReflect<ag::SceneObjectComponents>::metaobj { "ag::SceneObjectComponents", 
	  gsl::span<Field>{} ,
...
template <>
const Type* typeOf<ag::SceneObjectComponents>() {
...
const Record RecordReflect<ag::Light>::metaobj { "ag::Light", 
	  gsl::span<Field>{} ,
	  gsl::span<std::type_index>{} ,
	{},	// attribute table
...
template <>
struct RecordReflect<ag::LightComponents> {
	// attribute instances
...
const std::array<std::type_index, 1> RecordReflect<ag::LightComponents>::bases_data { {
	std::type_index { typeid(ag::ComponentManager<ag::Light>) } ,
} };


const Record RecordReflect<ag::LightComponents>::metaobj { "ag::LightComponents", 
	  gsl::span<Field>{} ,
...
template <>
const Type* typeOf<ag::LightComponents>() {
...
template <>
struct RecordReflect<ag::ISceneEditor> {
	// attribute instances
...
const std::array<std::type_index, 1> RecordReflect<ag::ISceneEditor>::bases_data { {
	std::type_index { typeid(ag::Extension) } ,
} };


const Record RecordReflect<ag::ISceneEditor>::metaobj { "ag::ISceneEditor", 
	  gsl::span<Field>{} ,
...
template <>
const Type* typeOf<ag::ISceneEditor>() {
...
template <>
struct RecordReflect<ag::ScriptContext> {
	// attribute instances
...
const std::array<std::type_index, 1> RecordReflect<ag::ScriptContext>::bases_data { {
	std::type_index { typeid(sol::state) } ,
} };


const Record RecordReflect<ag::ScriptContext>::metaobj { "ag::ScriptContext", 
	  gsl::span<Field>{} ,
...
template <>
const Type* typeOf<ag::ScriptContext>() {
...
template <>
struct RecordReflect<ag::PipelineStateCache> {
	// attribute instances
...
const Record RecordReflect<ag::PipelineStateCache>::metaobj { "ag::PipelineStateCache", 
	  gsl::span<Field>{} ,
	  gsl::span<std::type_index>{} ,
	{},	// attribute table
...
template <>
const Type* typeOf<ag::PipelineStateCache>() {
...
// struct ag::Shader
template <>
struct RecordReflect<ag::Shader> {
	// attribute instances
...
const Record RecordReflect<ag::Shader>::metaobj { "ag::Shader", 
	  gsl::span<Field>{} ,
	  gsl::span<std::type_index>{} ,
	{},	// attribute table
...
void RecordReflect<ag::CameraControl>::serialize(packer& p, const void* data) 
{
/*auto obj = reinterpret_cast<const ag::CameraControl*>(data);
p.pack_map(0);
*/
}
...
void RecordReflect<ag::Profiler::Scope>::serialize(packer& p, const void* data) 
{
...
void RecordReflect<ag::Profiler::ProfileData>::serialize(packer& p, const void* data) 
{
...
void RecordReflect<ag::ComponentManagerBase>::serialize(packer& p, const void* data) 
{
...
void RecordReflect<ag::RenderableComponents>::serialize(packer& p, const void* data) 
{
...
void RecordReflect<ag::SceneObjectComponents>::serialize(packer& p, const void* data) 
{
...
void RecordReflect<ag::LightComponents>::serialize(packer& p, const void* data) 
{
...
void RecordReflect<ag::PipelineStateCache>::serialize(packer& p, const void* data) 
{
...
const Type *typeOf(std::type_index ti)
{
	if (!typeindex_to_metaobject_initialized) {
		...
		typeindex_to_metaobject.insert({
			...
			kv_pair{typeid(ag::CameraControl), &RecordReflect<ag::CameraControl>::metaobj},
			...
			kv_pair{typeid(ag::Profiler::Scope), &RecordReflect<ag::Profiler::Scope>::metaobj},
			kv_pair{typeid(ag::Profiler::ProfileData), &RecordReflect<ag::Profiler::ProfileData>::metaobj},
			...
			kv_pair{typeid(ag::EntityManager), &RecordReflect<ag::EntityManager>::metaobj},
			kv_pair{typeid(ag::ComponentManagerBase), &RecordReflect<ag::ComponentManagerBase>::metaobj},
			kv_pair{typeid(ag::Scene), &RecordReflect<ag::Scene>::metaobj},
			kv_pair{typeid(ag::RenderableComponents), &RecordReflect<ag::RenderableComponents>::metaobj},
			kv_pair{typeid(ag::SceneObject), &RecordReflect<ag::SceneObject>::metaobj},
			kv_pair{typeid(ag::SceneObjectComponents), &RecordReflect<ag::SceneObjectComponents>::metaobj},
			kv_pair{typeid(ag::Light), &RecordReflect<ag::Light>::metaobj},
			kv_pair{typeid(ag::LightComponents), &RecordReflect<ag::LightComponents>::metaobj},
			kv_pair{typeid(ag::ISceneEditor), &RecordReflect<ag::ISceneEditor>::metaobj},
			kv_pair{typeid(ag::ScriptContext), &RecordReflect<ag::ScriptContext>::metaobj},
			kv_pair{typeid(ag::PipelineStateCache), &RecordReflect<ag::PipelineStateCache>::metaobj},
