...
AG_API void drawWireMesh(gl::Framebuffer &target, const Camera &cam,
...
// Draw a bounding box
AG_API void drawBoundingBox(gl::Framebuffer &target, const Camera &cam,
                            const AABB &aabb,
                            vec4 wireColor = vec4{1.0f, 1.0f, 0.0f, 1.0f});
// Draw a 2D grid
AG_API void drawGrid2D(gl::Framebuffer &target,
