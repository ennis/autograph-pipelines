...
////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////
class DeferredSceneRenderer_API DeferredSceneRenderer : public Extension {
public:
  ...
  void renderScene(gl::Framebuffer &target, SceneObjectComponents &sceneObjects,
...

    {
      ...
      gl::dispatchComputeOnImage2D(
          ...
          texture(3, depth, linearSampler), image(0, TAATarget1),
          image(1, TAADebug), uniformBuffer(0, uCamera),
...
extern "C" DeferredSceneRenderer_API void moduleInit() {
  AG_DEBUG("Module init!");
  // TODO: register stuff
  ag::registerClass<ag::DeferredSceneRenderer, ag::Extension>(
      "DeferredSceneRenderer");
}

extern "C" DeferredSceneRenderer_API void moduleExit() { AG_DEBUG("Module exit!"); }
