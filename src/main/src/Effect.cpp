...
sol::table openLuaModule_GL(sol::this_state s)
{
    ...
    module.new_usertype<gl::Texture>("Texture",
                     "create1D", sol::factories(&gl::Texture::create1D),
                     "create2D", sol::factories(&gl::Texture::create2D),
                     "width", sol::property(&gl::Texture::width),
                     "height", sol::property(&gl::Texture::height),
                     "format", sol::property(&gl::Texture::format),
                     "object", sol::property(&gl::Texture::object));

    module.new_usertype<gl::Buffer>("Buffer",
                                    "create", sol::factories(&gl::Buffer::create));
...
/*void registerLuaUsertypes(sol::state& lua)
{
    ...
    lua.new_usertype<DrawPassBuilder>("DrawPassBuilder",
                                      ...
                                      "bindVertexArray", &DrawPassBuilder::bindVertexArray,
                                      "bindColorBuffer", &DrawPassBuilder::bindColorBuffer,
                                      "bindDepthBuffer", &DrawPassBuilder::bindDepthBuffer,
                                      "bindVertexBuffer", &DrawPassBuilder::bindVertexBuffer,
                                      "addDependency", &DrawPassBuilder::addDependency,
                                      "setVertexShader", &DrawPassBuilder::setVertexShader,
                                      "setFragmentShader", &DrawPassBuilder::setFragmentShader,
                                      "addShaderKeyword", &DrawPassBuilder::addShaderKeyword,
                                      "addShaderDef", &DrawPassBuilder::addShaderDef
                                      );
