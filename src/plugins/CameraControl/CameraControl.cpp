  ...
  Camera getCamera() const {
    ...
    cam.projMat = glm::scale(vec3{zoomLevel_, zoomLevel_, 1.0f}) *
                  glm::perspective(glm::radians(fov_), aspectRatio_, nearPlane_,
                                   farPlane_);
    // glm::orthoRH(-1000.0f, 1000.0f, -1000.0f, 1000.0f, nearPlane_,
    // farPlane_);
    ...
    // AG_DEBUG("fov {} aspectRatio {} nearPlane {} farPlane {}",
    // cam.projMat[0], cam.projMat[1], cam.projMat[2], cam.projMat[3]);
