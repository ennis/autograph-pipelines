...
Texture loadTexture(std::experimental::filesystem::path path,
  ...
  TextureSubImage2D(tex.object(), 0, 0, 0, desc.width, desc.height,
                        gl::RGBA, gl::UNSIGNED_INT_8_8_8_8_REV, raw_data);
  return tex;
}
...
void saveTexture(std::experimental::filesystem::path path, Texture &tex) {
  ...
  gl::GetTextureImage(tex.object(), 0, gl::RGBA, gl::UNSIGNED_INT_8_8_8_8_REV,
