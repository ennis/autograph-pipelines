...
namespace ag {
	...
	public:
		...
		virtual void onSceneEditorGUI(Scene& s, ID& selectedID, const Camera& camera, ResourcePool& resourcePool) override
		{
...
extern "C" SceneEditor_API void moduleInit() {
	AG_DEBUG("Module init!");
	ag::registerClass<ag::SceneEditor, ag::ISceneEditor>("SceneEditor");
}

extern "C" SceneEditor_API void moduleExit() { AG_DEBUG("Module exit!"); }
